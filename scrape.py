def main():
    import datetime, requests, webbrowser, tkinter, sys
    ...
    def versionWindow():
        ...
        version = tkinter.Label(infoFrame, text="v2.3.1 | Jul 5, 2023")
        version.grid(row=1, column=0, sticky="w")

        tkVersion = tkinter.Label(infoFrame, text=tkinter.TkVersion)
        tkVersion.grid(row=2, column=0, sticky="w")

        pyVersion = tkinter.Label(infoFrame, text=sys.version)
